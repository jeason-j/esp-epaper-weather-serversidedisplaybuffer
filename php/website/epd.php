...
$epd->clearbuffer();
   $epd->SetFont(12);
    ...
    $epd->DrawUTF(3,145,12,12,"今天"." ".$obj->HeWeather5[0]->daily_forecast[0]->tmp->min."°~".$obj->HeWeather5[0]->daily_forecast[0]->tmp->max."°");
	$epd->DrawUTF(15,145,12,12,$obj->HeWeather5[0]->daily_forecast[0]->cond->txt_d."/".$obj->HeWeather5[0]->daily_forecast[0]->cond->txt_n);
    $epd->DrawUTF(32,145,12,12,"明天"." ".$obj->HeWeather5[0]->daily_forecast[1]->tmp->min."°~".$obj->HeWeather5[0]->daily_forecast[1]->tmp->max."°");
    $epd->DrawUTF(44,145,12,12,$obj->HeWeather5[0]->daily_forecast[1]->cond->txt_d."/".$obj->HeWeather5[0]->daily_forecast[1]->cond->txt_n);
    $epd->DrawXbm_P(61,116,12,12,$epd->aqi_icon); 
    $epd->DrawUTF(61,131,12,12,"空气质量:".$obj->HeWeather5[0]->aqi->city->qlty);
   

     $epd->DrawXbm_P(76,116,12,12,$epd->message);
    $epd->DrawUTF(76,131,12,12,$message);
